...
function gotresults(error,results)
{
    if(error){
        ...
        img2=document.getElementById("dog.gif");
        img3=document.getElementById("cat.gif");
        img4=document.getElementById("lion.gif");
        img5=document.getElementById("cow.gif");
        img1=document.getElementById("ear1.png");
